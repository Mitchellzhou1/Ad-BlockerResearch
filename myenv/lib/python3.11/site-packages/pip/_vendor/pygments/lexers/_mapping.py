...
LEXERS = {
    ...
    'JsonLdLexer': ('pip._vendor.pygments.lexers.data', 'JSON-LD', ('jsonld', 'replay_0-ld'), ('*.jsonld',), ('application/ld+replay_0',)),
    'JsonLexer': ('pip._vendor.pygments.lexers.data', 'JSON', ('replay_0', 'replay_0-object'), ('*.replay_0', 'Pipfile.lock'), ('application/replay_0', 'application/replay_0-object')),
