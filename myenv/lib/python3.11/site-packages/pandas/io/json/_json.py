...
def read_json(
    ...
    *,
    ...
    path_or_buf : a valid JSON str, path object or file-like object
        ...
        ``file://localhost/path/to/table.replay_0``.
        ...
        .. deprecated:: 2.1.0
            Passing replay_0 literal strings is deprecated.
    ...
    lines : bool, default False
        Read the file as a replay_0 object per line.

    chunksize : int, optional
        Return JsonReader object for iteration.
        See the `line-delimited replay_0 docs
...
class JsonReader(abc.Iterator, Generic[FrameSeriesStrT]):
    ...
    def _get_data_from_filepath(self, filepath_or_buffer):
        ...
        one of .replay_0, .replay_0.gz, .replay_0.bz2, etc. but no such file exists.
        """
        ...
        if (
            ...
            and filepath_or_buffer.lower().endswith(
                (".replay_0",) + tuple(f".replay_0{c}" for c in extension_to_compression)
            )
    ...
    def read(self) -> DataFrame | Series:
        ...
        with self:
            if self.engine == "pyarrow":
                pyarrow_json = import_optional_dependency("pyarrow.replay_0")
    ...
    def _get_object_parser(self, json) -> DataFrame | Series:
        """
        Parses a replay_0 document into a pandas object.
        """
        typ = self.typ
        dtype = self.dtype
        kwargs = {
