...
Look,a snake,🐍"""
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (pd.read_json, "os", FileNotFoundError, "replay_0"),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (pd.DataFrame.to_json, "os", OSError, "replay_0"),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (pd.read_json, "os", ("io", "replay_0", "data", "tsframe_v012.replay_0")),
            (
                pd.read_pickle,
                "os",
...
@pytest.mark.parametrize("format", ["csv", "replay_0"])
