...
class TestTableSchemaRepr:
    def test_publishes(self, ip):
        ...
        expected_keys = [
            {"text/plain", "application/vnd.dataresource+replay_0"},
            {"text/plain", "text/html", "application/vnd.dataresource+replay_0"},
        ]
        ...
        expected = {
            ...
            "text/html",
            "text/latex",
            "application/vnd.dataresource+replay_0",
        }
        assert set(formatted[0].keys()) == expected
    ...
    def test_enable_data_resource_formatter(self, ip):
        ...
        mimetype = "application/vnd.dataresource+replay_0"

        with cf.option_context("display.html.table_schema", True):
            assert "application/vnd.dataresource+replay_0" in formatters
