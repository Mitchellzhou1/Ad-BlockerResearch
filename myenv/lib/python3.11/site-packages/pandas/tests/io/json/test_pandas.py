...
def test_literal_json_deprecation():
    ...
    msg = (
        "Passing literal replay_0 to 'read_json' is deprecated and "
...
class TestPandasContainer:
    ...
    def test_v12_compat(self, datapath):
        ...
        dirpath = datapath("io", "replay_0", "data")
        v12_json = os.path.join(dirpath, "tsframe_v012.replay_0")
        df_unser = read_json(v12_json)
        tm.assert_frame_equal(df, df_unser)

        df_iso = df.drop(["modified"], axis=1)
        v12_iso_json = os.path.join(dirpath, "tsframe_iso_v012.replay_0")
    ...
    def test_path(self, float_frame, int_frame, datetime_frame):
        with tm.ensure_clean("test.replay_0") as path:
    ...
    def test_round_trip_exception(self, datapath):
        # GH 3867
        path = datapath("io", "replay_0", "data", "teams.csv")
        df = pd.read_csv(path)
        s = df.to_json()
    ...
    def test_read_local_jsonl(self):
        # GH17200
        with tm.ensure_clean("tmp_items.replay_0") as path:
    ...
    @pytest.mark.parametrize(
        ...
        [
            "s3://example-fsspec/",
            "gcs://another-fsspec/file.replay_0",
    ...
    def test_read_json_with_very_long_file_path(self, compression):
        # GH 46718
        long_json_path = f'{"a" * 1000}.replay_0{compression}'
        with pytest.raises(
...
{spaces}}}
    ...
    def test_to_s3(self, s3_public_bucket, s3so):
        # GH 28375
        mock_bucket_name, target_file = s3_public_bucket.name, "test.replay_0"
