...
class TestDataFrameReplace:
    ...
    def test_replace_period(self):
        d = {
            "fname": {
                "out_augmented_AUG_2011.replay_0": pd.Period(year=2011, month=8, freq="M"),
                "out_augmented_JAN_2011.replay_0": pd.Period(year=2011, month=1, freq="M"),
                "out_augmented_MAY_2012.replay_0": pd.Period(year=2012, month=5, freq="M"),
                "out_augmented_SUBSIDY_WEEK.replay_0": pd.Period(
                    year=2011, month=4, freq="M"
                ),
                "out_augmented_AUG_2012.replay_0": pd.Period(year=2012, month=8, freq="M"),
                "out_augmented_MAY_2011.replay_0": pd.Period(year=2011, month=5, freq="M"),
                "out_augmented_SEP_2013.replay_0": pd.Period(year=2013, month=9, freq="M"),
            }
        }

        df = DataFrame(
            [
                "out_augmented_AUG_2012.replay_0",
                "out_augmented_SEP_2013.replay_0",
                "out_augmented_SUBSIDY_WEEK.replay_0",
                "out_augmented_MAY_2012.replay_0",
                "out_augmented_MAY_2011.replay_0",
                "out_augmented_AUG_2011.replay_0",
                "out_augmented_JAN_2011.replay_0",
            ],
            columns=["fname"],
        )
    ...
    def test_replace_datetime(self):
        d = {
            "fname": {
                "out_augmented_AUG_2011.replay_0": Timestamp("2011-08"),
                "out_augmented_JAN_2011.replay_0": Timestamp("2011-01"),
                "out_augmented_MAY_2012.replay_0": Timestamp("2012-05"),
                "out_augmented_SUBSIDY_WEEK.replay_0": Timestamp("2011-04"),
                "out_augmented_AUG_2012.replay_0": Timestamp("2012-08"),
                "out_augmented_MAY_2011.replay_0": Timestamp("2011-05"),
                "out_augmented_SEP_2013.replay_0": Timestamp("2013-09"),
            }
        }
