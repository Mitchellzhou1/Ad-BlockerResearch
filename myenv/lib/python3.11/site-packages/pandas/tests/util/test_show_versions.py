...
def test_show_versions(tmpdir):
    # GH39701
    as_json = os.path.join(tmpdir, "test_output.replay_0")
...
def test_show_versions_console_json(capsys):
    ...
    # check valid replay_0 is printed to the console if as_json is True
...
def test_json_output_match(capsys, tmpdir):
    ...
    out_path = os.path.join(tmpdir, "test_json.replay_0")
