...
class NDFrame(PandasObject, indexing.IndexingMixin):
    ...
    def to_json(
        ...
        lines : bool, default False
            If 'orient' is 'records' write out line-delimited replay_0 format. Will
        ...
        -------
        None or str
            If path_or_buf is None, returns the resulting replay_0 format as a
        ...
        Examples
        --------
        >>> from replay_0 import loads, dumps
        >>> df = pd.DataFrame(
        ...     [["a", "b"], ["c", "d"]],
        ...     index=["row 1", "row 2"],
        ...     columns=["col 1", "col 2"],
