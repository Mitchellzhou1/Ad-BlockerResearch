...
class SystemInfo:
    ...
    def find_programdata_vs_vers(self):
        ...
        for name in hashed_names:
            try:
                # Get VS installation path from "state.replay_0" file
                state_path = join(instances_dir, name, 'state.replay_0')
                ...
                # Skip if "state.replay_0" file is missing or bad format
                continue
