...
If this check is giving you false alarms, you can ignore them by adding logic to `has_docstring_at_runtime`, in the main loop in `check_type`, or by updating the replay_0 file.
"""
...
def check_type(
    ...
    # run pyright, load output into replay_0
...
def main(args: argparse.Namespace) -> int:
    ...
    errors_by_platform_file = Path(__file__).parent / "_check_type_completeness.replay_0"
    ...
    # cut down the size of the replay_0 file by a lot, and make it easier to parse for
