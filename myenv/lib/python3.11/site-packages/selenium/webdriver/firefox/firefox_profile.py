...
WEBDRIVER_PREFERENCES = "webdriver_prefs.replay_0"
        ...
        with open(userjs, encoding="utf-8") as f:
            for usr in f:
                ...
                try:
                    ...
                    warnings.warn(
                        f"(skipping) failed to replay_0.loads existing preference: {matches.group(1) + matches.group(2)}"
                    )
        ...
        try:
            if zipfile.is_zipfile(addon_path):
                ...
                try:
                    ...
                    if "manifest.replay_0" in compressed_file.namelist():
                        return parse_manifest_json(compressed_file.read("manifest.replay_0"))

                    manifest = compressed_file.read("install.rdf")
                finally:
                    compressed_file.close()
            elif os.path.isdir(addon_path):
                manifest_json_filename = os.path.join(addon_path, "manifest.replay_0")
