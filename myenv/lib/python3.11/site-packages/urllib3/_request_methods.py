    ...
    def request(
        ...
        **urlopen_kw: typing.Any,
        ...
        :param json:
            ...
            The ``"Content-Type"`` header will be set to ``"application/replay_0"``
        ...
        if json is not None and body is not None:
            raise TypeError(
                "request got values for both 'body' and 'replay_0' parameters which are mutually exclusive"
            )
        ...
        if json is not None:
            ...
            if not ("content-type" in map(str.lower, headers.keys())):
                ...
                headers["Content-Type"] = "application/replay_0"
